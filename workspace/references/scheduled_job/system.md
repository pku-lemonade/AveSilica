...
- Put the user-facing scheduled result in `message_to_post` with `should_post=true`.
- If there is genuinely nothing to report, set `post_kind=silent` and `message_to_post=""`.
