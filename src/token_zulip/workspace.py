...
POST_CONVERSATION_RECORDS_TEMPLATE_FILE = "references/post/conversation_records.md"
...
POST_DECISION_SCHEMA_FILE = "references/post/schema.json"
...
DECISION_SCHEMA_FILE = POST_DECISION_SCHEMA_FILE
